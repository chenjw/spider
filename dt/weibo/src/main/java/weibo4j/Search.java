...
public class Search extends Weibo{
	...
	public JSONArray searchSuggestionsUsers(String q) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/users.json",new PostParameter[]{
	...
	public JSONArray searchSuggestionsStatuses(String q) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/statuses.json",new PostParameter[]{
			new PostParameter("q", q)
		}).asJSONArray();
	}
	...
	public JSONArray searchSuggestionsCompanies(String q) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/companies.json",new PostParameter[]{
			new PostParameter("q", q)
		}).asJSONArray();
	}
	...
	public JSONArray searchSuggestionsApps(String q) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/apps.json",new PostParameter[]{
			new PostParameter("q", q)
		}).asJSONArray();
	}
	...
	public JSONArray searchSuggestionsSchools(String q) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/schools.json",new PostParameter[]{
			new PostParameter("q", q)
		}).asJSONArray();
	}
	...
	public JSONArray searchSuggestionsAt_users(String q,int type) throws WeiboException{
		return client.get(WeiboConfig.getWeiboInfo().getBaseUrl()+"search/suggestions/at_users.json",new PostParameter[]{
			new PostParameter("q", q),
			new PostParameter("type", type)
		}).asJSONArray();
	}
