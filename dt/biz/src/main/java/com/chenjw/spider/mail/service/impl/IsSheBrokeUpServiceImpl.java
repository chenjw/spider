...
public class IsSheBrokeUpServiceImpl implements IsSheBrokeUpService,InitializingBean {
	...
	private boolean isDeleted(){
		String result = null;
		try {
			result = httpClient.get(UrlParseUtils.parseUrl("http://weibo.com/2646772100/zhZ1FdYYG"), "UTF-8", cookie);
